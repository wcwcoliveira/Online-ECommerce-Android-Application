...
public class BrowseFragment extends Fragment  implements RecyclerViewAdapter.ClickListener {
    ...
    final private int PIC_IMAGE = 50;
    ...
    private void onRestoreInstanceState(Bundle savedInstanceState){
        if(savedInstanceState !=null){
            fileUri = savedInstanceState.getParcelable("file_url");
    ...
    private void setupFloatingActionMenu(Context context) {
        ...
        final ImageView capture = new ImageView(context);
        ...
        buttonSortUpd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(Intent.createChooser(intent, ""), PIC_IMAGE);
    ...
    private void captureImage() {
        ...
        fileUri = getOutputMediaFileUri(PIC_IMAGE);
            ...
            public void done(List<ParseObject> list, ParseException e) {
                ...
                if (e == null) {
                    ...
                    for (int a = 0; a < list.size(); a++) {
                        ...
                        model.setPrice((object.getNumber("phone").toString()));
